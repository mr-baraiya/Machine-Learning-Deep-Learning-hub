...
function FAQs() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "The Random Forest model achieves approximately 74.74% accuracy and the Logistic Regression model achieves about 72.93% accuracy on the test dataset. However, these are academic metrics and should not be used for actual medical diagnosis."
    },
    {
